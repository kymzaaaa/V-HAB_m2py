class StationaryMixedBed_P2P(matter.procs.p2ps.stationary, components.matter.WPA.components.baseMixedBed_P2P):
    """
    Represents a stationary mixed bed P2P process.
    Combines the functionality of the stationary P2P and the baseMixedBed_P2P components.
    """

    def __init__(self, oStore, sName, sPhaseIn, sPhaseOut, oDesorptionP2P):
        """
        Constructor for the StationaryMixedBed_P2P class.
        ...
        components.matter.WPA.components.baseMixedBed_P2P.__init__(self, oStore, oDesorptionP2P)
